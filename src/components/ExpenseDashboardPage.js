...
const ExpenseDashboardPage = () => <div>why is not showing</div>;
//ADD_EXPENSE
const addExpense = ({
  description = "",
  note = "",
...
const expensesReducerDefaultSatate = [];
const expensesReducer = (state = expensesReducerDefaultSatate, action) => {
  switch (action.type) {
    case "ADD_EXPENSE":
